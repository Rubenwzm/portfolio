...
export namespace Prisma {
  ...
  */
  ...
  export type DesignOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "title" | "description" | "imagePath" | "createdAt", ExtArgs["result"]["design"]>
  ...
  interface DesignFieldRefs {
    ...
    readonly imagePath: FieldRef<"Design", 'String'>
  ...
  export type DesignWhereInput = {
    ...
    imagePath?: StringFilter<"Design"> | string
  ...
  export type DesignScalarWhereWithAggregatesInput = {
    ...
    imagePath?: StringWithAggregatesFilter<"Design"> | string
